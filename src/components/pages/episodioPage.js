    ...
    return(
        <Container>
            <div style={{ marginTop: '10px', marginBottom: '10px', textAlign: "left" }}>
                <a href={`/episodios`} className="btn btn-primary btn-sm">Regresar</a>
            </div>
            <div>
                <h1>Episodio</h1>
                <Card 
                ...
                >
                    <Card.Body>
                        ...
                        <Card.Text style={{ textAlign: 'center', padding: '10px' }}>
                            {fetchedData.episode}<br />
                            {fetchedData.air_date}
                        </Card.Text>
                    </Card.Body>
                </Card>
            </div>
            <div style={{ marginTop: '15px' }}>
                <h2>Personajes</h2>
                {fetchedData.hasOwnProperty('characters') 
                ?
                fetchedData.characters.map((personaje) =>{
                    return (
